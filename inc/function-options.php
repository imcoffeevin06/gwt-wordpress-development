...
class GOVPH
{
  ...
  public function register_settings_fields()
  {
    ...
    add_settings_section('govph_main_section', '', [$this, 'govph_main_section_cb'], __FILE__);
    add_settings_field('govph_general_section', '<h3>General Options<h3>', [$this, 'govph_general_section'], __FILE__, 'govph_main_section');
    add_settings_field('govph_disable_search', 'Search Enable', [$this, 'govph_disable_search'], __FILE__, 'govph_main_section');
    add_settings_field('govph_logo_enable', 'Enable Image Logo', [$this, 'govph_logo_enable'], __FILE__, 'govph_main_section');
    add_settings_field('govph_agency_name', 'Agency Name', [$this, 'govph_agency_name'], __FILE__, 'govph_main_section');
    add_settings_field('govph_agency_tagline', 'Agency Tagline', [$this, 'govph_agency_tagline'], __FILE__, 'govph_main_section');
    add_settings_field('govph_header_font_color', 'Header Font Color', [$this, 'govph_header_font_color'], __FILE__, 'govph_main_section');
    add_settings_field('govph_logo_position', 'Logo Position', [$this, 'govph_logo_position_setting'], __FILE__, 'govph_main_section');
    add_settings_field('govph_logo', 'Image Logo', [$this, 'govph_logo_setting'], __FILE__, 'govph_main_section');
    add_settings_field('govph_headercolor', 'Header Background Color', [$this, 'govph_header_color_setting'], __FILE__, 'govph_main_section');
    add_settings_field('govph_headerimage', 'Header Background Image', [$this, 'govph_header_image_setting'], __FILE__, 'govph_main_section');
    add_settings_field('govph_slidercolor', 'Slider Background Color', [$this, 'govph_slider_color_setting'], __FILE__, 'govph_main_section');
    add_settings_field('govph_sliderimage', 'Slider Background Image', [$this, 'govph_slider_image_setting'], __FILE__, 'govph_main_section');
    add_settings_field('govph_slider_fullwidth', 'Slider Full Width', [$this, 'govph_slider_fullwidth'], __FILE__, 'govph_main_section');
    
    // add govph_breadcrumbs separator and option
    add_settings_field('govph_breadcrumbs_enable', 'Enable Breadcrumbs', [$this, 'govph_breadcrumbs_enable'], __FILE__, 'govph_main_section');
    add_settings_field('govph_breadcrumbs_separator', 'Breadcrumbs Separator', [$this, 'govph_breadcrumbs_separator'], __FILE__, 'govph_main_section');
    add_settings_field('govph_breadcrumbs_show_home', 'Breadcrumb Homepage Link', [$this, 'govph_breadcrumbs_show_home'], __FILE__, 'govph_main_section');

    // custom styling
    add_settings_field('govph_custom_section', '<h3>Theme Styling<h3>', [$this, 'govph_custom_section'], __FILE__, 'govph_main_section');
    add_settings_field('govph_custom_pst', 'Philippine Standard Time', [$this, 'govph_custom_pst'], __FILE__, 'govph_main_section');
    add_settings_field('govph_custom_anchorcolor', 'Anchor Color Settings', [$this, 'govph_custom_anchorcolor'], __FILE__, 'govph_main_section');
    add_settings_field('govph_custom_anchorcolor_hover', 'Anchor Color Settings (Hover)', [$this, 'govph_custom_anchorcolor_hover'], __FILE__, 'govph_main_section');
    add_settings_field('govph_custom_panel_top', 'Panel Top Color', [$this, 'govph_custom_panel_top'], __FILE__, 'govph_main_section');
    add_settings_field('govph_custom_panel_bottom', 'Panel Bottom Color', [$this, 'govph_custom_panel_bottom'], __FILE__, 'govph_main_section');
    add_settings_field('govph_custom_border_width', 'Border Width', [$this, 'govph_custom_border_width'], __FILE__, 'govph_main_section');
    add_settings_field('govph_custom_border_radius', 'Border Radius', [$this, 'govph_custom_border_radius'], __FILE__, 'govph_main_section');
    add_settings_field('govph_custom_border_color', 'Border Color', [$this, 'govph_custom_border_color'], __FILE__, 'govph_main_section');
    add_settings_field('govph_custom_background_color', 'Background Color', [$this, 'govph_custom_background_color'], __FILE__, 'govph_main_section');
    add_settings_field('govph_custom_headings_text', 'Header Rendering', [$this, 'govph_custom_headings_text'], __FILE__, 'govph_main_section');
    add_settings_field('govph_custom_headings_size', 'Blog Title Header', [$this, 'govph_custom_headings_size'], __FILE__, 'govph_main_section');
    add_settings_field('govph_custom_headings_inner_page_size', 'Banner Title Header', [$this, 'govph_custom_headings_inner_page_size'], __FILE__, 'govph_main_section');
    add_settings_field('govph_custom_footer_background_color', 'Agency Footer Color', [$this, 'govph_custom_footer_background_color'], __FILE__, 'govph_main_section');

    // publishing options
    add_settings_field('govph_content_section', '<h3>Publishing Options<h3>', [$this, 'govph_content_section'], __FILE__, 'govph_main_section');
    add_settings_field('govph_content_show_pub_date', 'Show Published Date', [$this, 'govph_content_show_pub_date'], __FILE__, 'govph_main_section');
    add_settings_field('govph_content_pub_date_lbl', 'Publish Date Label', [$this, 'govph_content_pub_date_lbl'], __FILE__, 'govph_main_section');
    add_settings_field('govph_content_show_author', 'Show Publisher', [$this, 'govph_content_show_author'], __FILE__, 'govph_main_section');
    add_settings_field('govph_content_pub_author_lbl', 'Publish Author Label', [$this, 'govph_content_pub_author_lbl'], __FILE__, 'govph_main_section');

    // accessibility links
    add_settings_field('govph_acc_link_section', '<h3>Accessibility<h3>', [$this, 'govph_acc_link_section'], __FILE__, 'govph_main_section');
    add_settings_field('govph_acc_link_keys', 'Accessibility Combination Keys', [$this, 'govph_acc_link_keys'], __FILE__, 'govph_main_section');
    add_settings_field('govph_acc_link_statement', 'Accessibility Statement<br/>(Combination + 0)', [$this, 'govph_acc_link_statement'], __FILE__, 'govph_main_section');
    add_settings_field('govph_acc_link_home', 'Home Page<br/>(Combination + H)', [$this, 'govph_acc_link_home'], __FILE__, 'govph_main_section');
    add_settings_field('govph_acc_link_main_content', 'Main Content<br/>(Combination + R)', [$this, 'govph_acc_link_main_content'], __FILE__, 'govph_main_section');
    add_settings_field('govph_acc_link_contact', 'Contact<br/>(Combination + C)', [$this, 'govph_acc_link_contact'], __FILE__, 'govph_main_section');
    add_settings_field('govph_acc_link_feedback', 'Feedback<br/>(Combination + K)', [$this, 'govph_acc_link_feedback'], __FILE__, 'govph_main_section');
    add_settings_field('govph_acc_link_faq', 'FAQ<br/>(Combination + Q)', [$this, 'govph_acc_link_faq'], __FILE__, 'govph_main_section');
    add_settings_field('govph_acc_link_sitemap', 'Site Map<br/>(Combination + M)', [$this, 'govph_acc_link_sitemap'], __FILE__, 'govph_main_section');
    add_settings_field('govph_acc_link_search', 'Search<br/>(Combination + S)', [$this, 'govph_acc_link_search'], __FILE__, 'govph_main_section');
  }
  ...
  {
    $value = $this->options['govph_agency_name'] ?: '';
  ?>
  ...
  {
    $value = $this->options['govph_agency_tagline'] ?: '';
  ?>
  ...
  {
    $value = $this->options['govph_breadcrumbs_separator'] ?: ' › ';
  ?>
  ...
  {
    $value = $this->options['govph_acc_link_statement'] ?: '';
  ?>
  ...
  {
    $value = $this->options['govph_acc_link_home'] ?: '';
  ?>
    <span class="field-prefix"><?php echo get_site_url(); ?>/ </span>
  ...
  {
    $value = $this->options['govph_acc_link_main_content'] ?: '#main-content';
  ?>
  ...
  {
    $value = $this->options['govph_acc_link_sitemap'] ?: '#gwt-standard-footer';
  ?>
    <span class="field-prefix">{current_url}/ </span>
...
function mw_enqueue_color_picker( $hook_suffix ) {
  ...
  wp_enqueue_script('my-script-handle', get_template_directory_uri() . '/js/color.js', ['wp-color-picker'], false, true );
}
...
function govph_displayoptions( $options ){
  ...
  switch ($options) {
    ...
    case 'govph_acc_link_home':
      $value = '';
      $value .= get_site_url().'/'; 
      $value .= $option['govph_acc_link_home'] ?? '';
      return $value;
      break;
    case 'govph_acc_link_main_content':
      $value = '';
      $value .= $option['govph_acc_link_main_content'] ?? '#main-content';
      return $value;
      break;
    case 'govph_acc_link_sitemap':
      $value = '';
      $value .= $option['govph_acc_link_sitemap'] ?? '#gwt-standard-footer';
      return $value;
      break;
    case 'govph_content_show_pub_date':
      return $option['govph_content_show_pub_date'] ?? '';
      break;
    case 'govph_content_pub_date_lbl':
      return $option['govph_content_pub_date_lbl'] ?? '';
      break;
    case 'govph_content_show_author':
      return $option['govph_content_show_author'] ?? '';
      break;
    case 'govph_content_pub_author_lbl':
      return $option['govph_content_pub_author_lbl'] ?? '';
      break;
