...
class govph_widget_pst extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = ['classname' => 'pst_widget', 'description' => 'A widget for Philippine Standard Time.'];
...
class govph_widget_transparency extends WP_Widget {
	...
	function __construct() {
		// Instantiate the parent object
		$widget_ops = ['classname' => 'transparency_widget', 'description' => 'A widget for Transparency Seal logo.'];
